	...
	<section class="descricao-autor">
		<div class="center">
		<div class="w100 left">
			<h2 class="text-center"><img src="<?php echo INCLUDE_PATH ?>images/logo1.jpg"> <?php echo $infoSite['nome_autor']; ?></h2>
			<p><?php echo $infoSite['descricao']; ?></p>
		</div><!--w50-->
<!-- 		<div class="w50 left">
			<img class="right" src="<1?php //echo INCLUDE_PATH; ?>images/foto.jpg">
		</div><--w50-->
		<div class="clear"></div>
		</div><!--center-->
