...
<div class="box-content">
	<h2><i class="fa fa-id-card-o" aria-hidden="true"></i> Protudos no Estoque</h2>
	<div class="busca">
	...
	<?php 
		...
		if(isset($_POST['atualizar'])){
			...
			if($quantidade < 0){
				Painel::alert('erro','Você não pode atualizar a quantidade para menor a 0!');
			}else{
		...
		<div class="box-wraper">
			...
			<div style="width: 70%;float: left;border: 0;" class="box-single">
				...
				<div class="body-box">
					...
					<p><b><i class="fa fa-pencil"></i> Largura:</b> <?php echo $value['largura'] ?></p>
					<p><b><i class="fa fa-pencil"></i> Altura:</b> <?php echo $value['altura'] ?></p>
...
<?php }else{ ?>
	...
	<div class="box-content">
	<h2><i class="fa fa-id-card-o" aria-hidden="true"></i> <a href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-produtos">Produtos no Estoque</a> Protudos em Falta</h2>
