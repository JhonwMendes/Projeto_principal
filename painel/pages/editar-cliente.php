...
<div class="box-content">
	<h2><i class="fa fa-pencil"> Editar cliente</i></h2>
	...
	<form class="ajax" atualizar method="post" action="<?php echo INCLUDE_PATH_PAINEL ?>ajax/forms.php" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<select name="tipo_cliente">
				...
				<option <?php if($cliente['tipo'] == 'fisico') echo 'selected'; ?> value="juridico"> Juridíco</option>
			</select>
		</div><!--form-group-->
	...
	<form method="post">
		...
		?>
			...
			<div class="form-group">
				<label>Número de intervalo</label>
	...
	<table>
		...
		<tr <?php echo $style; ?>>
			...
			<td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>"><i class="fa fa-envelope"></i> E-mail</a></td>
