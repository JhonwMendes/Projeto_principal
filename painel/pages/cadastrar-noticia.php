<div class="box-content">
	<h2><i class="fa fa-user"></i> Cadastrar Notícia</h2>
		...
		<?php
			if(isset($_POST['acao'])){
				...
				if($titulo == '' || $conteudo == ''){
					...
					Painel::alert('erro','A imagem de capa precisa ser selecioanada.');
				}else{
					if(Painel::imagemValida($capa)){
						...
						//Painel::alert('sucesso','O cadastro da notícias foi realizado com sucesso');
						}else{
