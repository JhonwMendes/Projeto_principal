<?php
	...
	$meses = array('Janeiro','Fevereio','Março','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro');
...
<div class="box-content">
	...
	<div class="box-tarefas">
		<div class="card-title">Tarefas de <?php echo date('d/m/Y',time()); ?></div>
		<?php
		...
		?>
		<div class="tarefas-single">
			<h2><?php echo $value['tarefa']; ?></h2>
		</div>
		<?php } ?>
		<div class="clear"></div>
	</div>
