	...
	<div class="boxes">
		...
		<div class="box-wraper">
			<div class="box-single">
				...
				<div class="body-box">
					<p><b><i class="fa fa-info-circlo"></i> Nome do cliente:</b> <?php echo $value['nome']; ?></p>
					<p><b><i class="fa fa-info-circlo"></i> E-mail:</b> <?php echo $value['email']; ?></p>
					<p><b><i class="fa fa-info-circlo"></i> tipo:</b> <?php echo ucfirst($value['tipo']); ?></p>
					<p><b><i class="fa fa-info-circlo"></i> <?php
